...
const BASE_TITLE = "Aiero AI Agency & Technology Reactjs Template";
...
const pageMetaMap: Record<PageMetaKey, { title: string; description: string }> =
  {
    preview: {
      title: `All Demos | ${BASE_TITLE}`,
      description:
        "Browse all Aiero AI Agency & Technology Next.js demos, including AI consulting, chatbot, startup, SaaS, and creative portfolio homepages.",
    },
    "about-us": {
      title: `About Us | ${BASE_TITLE}`,
      description:
        "Learn more about Aiero AI Agency & Technology, our mission, team and expertise in AI-powered digital solutions.",
    },
    team: {
    ...
    contact: {
      ...
      description:
        "Get in touch with Aiero AI Agency & Technology using our contact details and inquiry form.",
    },
    service: {
      title: `Services | ${BASE_TITLE}`,
      description:
        "Overview of Aiero AI Agency & Technology services, including AI strategy, development, and integration.",
    },
    "service-single": {
      title: `Service Details | ${BASE_TITLE}`,
      description:
        "Detailed view for a single Aiero AI service such as Artificial Intelligence (AI) systems.",
    },
    shop: {
